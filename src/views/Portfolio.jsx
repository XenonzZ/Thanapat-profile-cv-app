    ...
    return (
        <div style={{ backgroundColor: "black", color: "white", fontFamily: "Arial, sans-serif" }}>
            <AppBar position="static" style={{ backgroundColor: "black" }}>
                <Toolbar>
                    <Typography variant="h6" style={{ flexGrow: 1 }}>THANAPAT THITISATHIENKUL</Typography>
            ...
            <Container style={{ padding: "40px 0" }}>
                <Grid container spacing={4} alignItems="center">
                    <Grid item xs={12} md={6}>
                        <Typography variant="h3" gutterBottom><br />HI, I AM <br />THANAPAT</Typography><br />
                ...
                <Grid container spacing={4} alignItems="center">
                    ...
                    <Grid item xs={12} md={5}><br /><br /><br />
                        ...
                        <Typography variant="body1" sx={{ mt: 2 }}>
                            Say hello at <a href="s6452410010@sau.ac.th" style={{ color: "#ff6e00" }}>s6452410010@sau.ac.th</a>
                        </Typography>
                        ...
                        <Typography variant="body1" color="gray" style={{ marginTop: '10px' }}>© Thanapat Thitisathienkul</Typography>
